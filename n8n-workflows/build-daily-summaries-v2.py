...
morning_connections = {
    ...
    "Fetch Today Data": {"main": [[{"node": "Format Morning Briefing", "type": "main", "index": 0}]]},
...
evening_connections = {
    ...
    "Fetch Data": {"main": [[{"node": "Format Evening Check", "type": "main", "index": 0}]]},
